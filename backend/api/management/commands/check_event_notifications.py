...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Check for events 30 minutes from now (with 2 minute window)
        ...
        # Check for events 10 minutes from now (with 2 minute window)
        ...
        # Find events in the 10-minute window (only future events)
